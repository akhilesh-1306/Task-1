...
// import { Container, Card, Row, Col, Badge, Modal, Form } from 'react-bootstrap';
...
//       try {
//         const token = localStorage.getItem("token");
//         const url = `http://localhost:8080/avail/delete-availability/${id}`;
//         const response = await fetch(url, {
//           method: 'DELETE',
//           headers: {
//             'Authorization': token,
...
//     try {
//       const token = localStorage.getItem("token");
//       const url = `http://localhost:8080/avail/update-availability/${editingAvailability.id}`;
//       const response = await fetch(url, {
//         method: 'PUT',
//         headers: {
//           'Authorization': token,
...
//                       Edit
//                     </Button>
//                     <Button variant="outline-danger" size="sm" onClick={() => handleDelete(availability.id)}>
//                       Delete
//                     </Button>
//                   </div>
//                 </Card.Body>
